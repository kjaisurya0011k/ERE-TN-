-- ====================================================================
-- V4: Seed Master Scholarships, Welfare Boards & College Cut-off Opportunities
-- With Verified Official Websites & Application URLs
-- ====================================================================

-- 1. Insert Providers
INSERT INTO providers (id, name, type, description, official_website, state, verification_status, last_verified_date)
VALUES
('prov-sabari-foundation', 'Sabari Foundation / Rajalakshmi Educational Trust', 'FOUNDATION', 'Administering full and partial merit-based scholarships for 190+ and 180+ cut-off students in Rajalakshmi Institutions.', 'https://ritchennai.org/', 'Tamil Nadu', 'VERIFIED', CURRENT_DATE),
...
VALUES
('inst-rit-chennai', 'Rajalakshmi Institute of Technology', 'AFFILIATED_COLLEGE', 'Anna University', 'Tamil Nadu', 'Chennai', 'https://ritchennai.org/', 'VERIFIED', 'Top tier autonomous engineering institution in Chennai providing Sabari Foundation full cut-off scholarships.'),
...
(
    ...
    200000, 'https://rsb.edu.in/scholarships/', 'https://ritchennai.org/', 'College Admissions / TNEA Counseling', '044-67181600',
...
(
    ...
    100000, 'https://rsb.edu.in/scholarships/', 'https://ritchennai.org/', 'College Admissions Office', '044-67181600',
